...
int main()
{
    ...
    omg::Holonomic* vehicles[N];
    omg::FormationPoint2Point* problems[N];
    ...
    for (int i=0; i<N; i++){
        vehicles[0] = new omg::Holonomic();
        vehicles[0]->setIdealPrediction(true);
        problems[0] = new omg::FormationPoint2Point(vehicles[0], update_time, sample_time, horizon_time, trajectory_length);
    }
