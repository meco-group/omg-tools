...
#  define CASADI_INTEGRATOR_CVODES_DEPRECATED_EXPORT CASADI_INTEGRATOR_CVODES_EXPORT __attribute__ ((__deprecated__))
#  define CASADI_INTEGRATOR_CVODES_DEPRECATED_NO_EXPORT CASADI_INTEGRATOR_CVODES_NO_EXPORT __attribute__ ((__deprecated__))
#endif
