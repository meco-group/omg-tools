...
vehicle.set_initial_conditions([1, 0., 0., 0.])  # x, y, theta, delta
vehicle.set_terminal_conditions([3, 0., 0.])  # x, y, theta
...
# environment.add_obstaclhe(Obstacle({'position': [3.4, -0.35]}, shape=rectangle))
