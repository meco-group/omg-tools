...
split_circle = True
bounds = {'vmin':-83000, 'vmax':83000,  # 300km/h
          'amin':-49e3, 'amax':49e3,  # 5G
          'jmin':-150e9, 'jmax':150e9}  # [mm]
...
import pdb; pdb.set_trace()  # breakpoint 8ef9b113 //
# plot measured positions on reference workpiece
import numpy as np
pos_data = np.loadtxt(open("realposition_anchor.csv", "rb"), delimiter=",")
