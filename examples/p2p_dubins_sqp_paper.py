...
# create vehicle
vehicle = Dubins(shapes=Circle(0.2), bounds={'vmax': 0.7, 'wmax': np.pi/1.2, 'wmin': -np.pi/1.2}, # in rad/s
...
#####ipopt with limited memory Hessian, using init guess from ipopt with exact Hessian
...
#                      'hess_lim_mem':1}}})
#                      # 'block_hess':1, 'hess_update':2, 'hess_lim_mem':1}}})  #1
