...
# create vehicle
vehicle = HolonomicOrient(shapes=Square(0.4))
number_knot_intervals = 15.
...
# run it!
simulator.run_once()
problem.save_movie('scene', format='gif', name='traileroff_rechtdoor5', number_of_frames=100, movie_time=5, axis=False)
