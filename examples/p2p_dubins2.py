...
trajectories = {'velocity': {'time': [0.5],
                             'values': [[0.25, 0.0]]}}
rec1 = Rectangle(width=3., height=0.5)
rec2 = Rectangle(width=1., height=0.5)
environment.add_obstacle(Obstacle({'position': [-2., 1.5]}, shape=rec1))
environment.add_obstacle(Obstacle({'position': [2., 1.5]}, shape=rec2))
trajectories = {'position': {'time': [4.],
                             'values': [[3.5, 1.5]]}}
environment.add_obstacle(Obstacle({'position': [3.5, -5.]}, shape=Circle(1),
